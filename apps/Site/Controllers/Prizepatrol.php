...
{	
    ...
    protected $list_route = '/prizepatrol';
    protected $create_item_route = '/prizepatrol/create';
    protected $create_item_confirm_route = '/prizepatrol/confirm/{id}';
    protected $create_item_customer_route = '/prizepatrol/customer/{id}';
    protected $get_item_route = '/prizepatrol/view/{id}';    
    protected $edit_item_route = '/prizepatrol/edit/{id}';
    ...
    protected function displayEdit()
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Site/Views::attendee/edit.php');
    }
     public function confirm() 
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Site/Views::attendee/confirm.php');
    }
