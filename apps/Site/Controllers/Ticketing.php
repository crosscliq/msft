...
{	
    ...
    public  function display() 
    {
        ...
        echo $view->render('Site/Views::ticketing/home.php');
    }
    ...
    protected function displayCreate() 
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Site/Views::ticketing/register.php');
    }
    ...
    protected function displayEdit()
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Site/Views::ticketing/edit.php');
    }
    ...
    public function attendee() 
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Site/Views::ticketing/attendee.php');
    }
