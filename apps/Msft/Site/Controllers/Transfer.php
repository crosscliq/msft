...
{   
    ...
    public function home() {
        ...
        echo $view->render('Msft/Site/Views::transfer/home.php');
    }
     public function notempty() {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::transfer/notempty.php');
    }
     ...
     public function isempty() {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::transfer/empty.php');
    }
    ...
    public function origin() {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::transfer/origin.php');
    }
    ...
    public function destination() {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::transfer/destination.php');
    }
    ...
    protected function displayEdit()
    {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::attendee/edit.php');
    }
     public function confirm() 
    {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::attendee/confirm.php');
    }
    ...
    public function attendee() 
    {
        ...
        $view = \Dsc\System::instance()->get( 'theme' );
        echo $view->render('Msft/Site/Views::attendee/attendee.php');
    }
