...
{	
    ...
    public  function display() 
    {
        ...
        echo $view->render('Msft/Views::ticketing/home.php');
    }
    ...
    protected function displayCreate() 
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Msft/Views::ticketing/register.php');
    }
    ...
    protected function displayEdit()
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Msft/Views::ticketing/edit.php');
    }
    ...
    public function confirm() 
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Msft/Views::ticketing/confirm.php');
    }
    ...
    public function attendee() 
    {
        ...
        $view = new \Dsc\Template;
        echo $view->render('Msft/Views::ticketing/attendee.php');
    }
